...
import { Badge, Container, Navbar , Nav, Button, NavDropdown  } from "react-bootstrap";
      ...
      {/* <Button
       ...
       <Link to = "/cart" className = "nav-link">
        ...
        {userInfo && userInfo.isCoach && (
          <NavDropdown title = "Coach" id = "admin-nav-dropdown">
            <LinkContainer to = "/Coach">
            <NavDropdown.Item>CoachScreen</NavDropdown.Item>
            </LinkContainer>
          </NavDropdown>
        )}
        {userInfo && userInfo.isCustomer && (
          <NavDropdown title = "appointments" id = "admin-nav-dropdown">
            <LinkContainer to = "/Doctor_home">
            <NavDropdown.Item>make an appointment</NavDropdown.Item>
            </LinkContainer>
            <LinkContainer to = "/myDoctor_appointments">
